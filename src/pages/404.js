  ...
  return (
    <Box className='content-center'>
      <Box sx={{ p: 5, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        <Img alt='error-illustration' src='/images/logos/logo-mar.png' width={150} />
        ...
        <BoxWrapper>
          ...
          <Typography variant='body2'>Nous n'avons pas trouvé la page que vous recherchez.</Typography>
        </BoxWrapper>
