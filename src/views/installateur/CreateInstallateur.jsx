...
const CreateInstallateur = ({ path, addTiersWithModal, openModalAddEntreprise, setOpenModalAddEntreprise }) => {
  // ** States
  ...
  // ** Query
  const createCompanyMutation = useCreateCompany({ profile: 'installers' })
...
export default CreateInstallateur
