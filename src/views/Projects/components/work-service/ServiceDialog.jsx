...
const ServiceDialog = ({
  ...
  const handleAddArticle = article => {
    onSelectArticle(article, row)
  }

  const handleRemoveArticle = article => {
    onDeleteArticle(article, row)
  }
                  ...
                  <TableRow key={index}>
                    <TableCell align='center'>
                      {selectedArticles.find(
                        selectedArticle =>
                          selectedArticle.d_service_id === article.id || selectedArticle.d_article_id === article.id
                      ) ? (
                        <IconButton color='error' onClick={() => handleRemoveArticle(article)}>
