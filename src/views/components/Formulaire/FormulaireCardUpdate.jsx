...
import LigneTypeOne from './form-inputs/LigneTypeOne'
import SubTitle from './form-inputs/SubTitle'
import Title from './form-inputs/Title'
import LigneTypeFour from './form-inputs/LigneTypeFour'
import LigneTypeSix from './form-inputs/LigneTypeSix'
import LigneTypeThree from './form-inputs/LigneTypeThree'
import LigneTypeSeven from './form-inputs/LigneTypeSeven'
import LigneTypeTwo from './form-inputs/LigneTypeTwo'
import LigneTypeNine from './form-inputs/LigneTypeNine'
import { returnFieldAfterChange } from './form-inputs/HandleChangeFcuntions'
import CircularProgress from '@mui/material/CircularProgress'

import EditorComponent from './form-inputs/EditorComponent'
...
const FormulaireCardUpdate = ({ idProject, idDocument }) => {
  ...
  const postFormMutation = usePostFormulaireForProject({ id: idProject, idDocument: idDocument })
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      router.push(`/demandes/${idProject}/edit`)
    } catch (error) {
      setIsLoading(false)
      setIsLoading(false)
    }
  ...
  return (
    <div
      title='Formulaire'
      headerColor='red.primary'

      // backButton
      // goBackLink={`/inspections/${inspectionData?.data?.id}/details`}
    >
      <div
        style={{
          display: 'flex',
      ...
      >
        <CardActions style={{ display: 'inline-flex', justifyContent: 'flex-end', padding: 1 }}>
          <LoadingButton
